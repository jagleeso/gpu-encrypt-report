...
% \end{thebibliography}
    ...
    % @online{specs,
    %     title = {{PDAdb.net - Qualcomm Snapdragon S4 Pro MSM8960DT multi-core application processor with Modem Datasheet}},
    %     url = {\url{http://www.pdadb.net/index.php?m=cpu&id=a8960dt&c=qualcomm_snapdragon_s4_pro_msm8960dt}},
    %     month = {12},
    %     year = {2013},
    % },
